            ...
            <form onSubmit={handleLoginForm} className="space-y-8">
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input type="email" name="email" id="email" placeholder="leroy@jenkins.com" className="w-full px-3 py-2 border rounded-md dark:border-gray-300  text-gray-700" fdprocessedid="zp9mzl" />
                    </div>
                    <div className="space-y-2">
                        <div className="flex justify-between">
                            <label htmlFor="password" className="text-sm">Password</label>
                        </div>
                        <input type="password" name="password" id="password" placeholder="*****" className="w-full px-3 py-2 border rounded-md text-gray-700 focus:dark:border-violet-600" fdprocessedid="ilhtzj" />
                    </div>
                </div>
                <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md bg-primary text-white hover:bg-[#E67E22]" fdprocessedid="jz968">Sign in</button>
            </form>
        </div>
    );
};
